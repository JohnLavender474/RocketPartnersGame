...
public class AbstractBoundsLayer implements ITiledMapLayerBuilder {
    ...
    public void build(@NotNull MapLayer mapLayer, @NotNull Properties properties) {
        mapLayer.getObjects().forEach(object -> {
            if (object instanceof RectangleMapObject) {
                ...
                BaseBlock abstractBounds = new BaseBlock(game, BodyType.STATIC, true);
                game.getEngine().spawn(abstractBounds, spawnProps);
            }
        });
    }
}
